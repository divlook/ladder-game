...
const initLogRocket = () => {
  if (constants["e" /* USE_LOGROCKET */]) {
    external_logrocket_["init"](constants["b" /* LOGROCKET_ID */], {
      release: `${constants["c" /* NODE_ENV */]}@${constants["a" /* LADDER_VERSION */]}`
    });
...
const withSentry = Sentry => {
  if (constants["e" /* USE_LOGROCKET */] && constants["f" /* USE_SENTRY */]) {
