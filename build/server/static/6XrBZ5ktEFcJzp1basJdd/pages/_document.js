...
/* harmony import */ var _plugins_sentry__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__("wBnB");
...
process.on('unhandledRejection', err => void _plugins_sentry__WEBPACK_IMPORTED_MODULE_3__["captureException"](err));
process.on('uncaughtException', err => void _plugins_sentry__WEBPACK_IMPORTED_MODULE_3__["captureException"](err));
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return NODE_ENV; });
/* unused harmony export IS_PRODUCTION */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return LADDER_VERSION; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "d", function() { return SENTRY_DSN; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "f", function() { return USE_SENTRY; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return LOGROCKET_ID; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "e", function() { return USE_LOGROCKET; });
...
var _process$env$NODE_ENV, _process$env$LADDER_P, _process$env$LADDER_P2;
...
const init = () => {
  if (_lib_constants__WEBPACK_IMPORTED_MODULE_1__[/* USE_SENTRY */ "f"]) {
    _sentry_browser__WEBPACK_IMPORTED_MODULE_0__["init"]({
      dsn: _lib_constants__WEBPACK_IMPORTED_MODULE_1__[/* SENTRY_DSN */ "d"],
      environment: _lib_constants__WEBPACK_IMPORTED_MODULE_1__[/* NODE_ENV */ "c"],
      release: _lib_constants__WEBPACK_IMPORTED_MODULE_1__[/* LADDER_VERSION */ "a"]
    });
  }
};
const withScope = callback => {
  if (_lib_constants__WEBPACK_IMPORTED_MODULE_1__[/* USE_SENTRY */ "f"]) _sentry_browser__WEBPACK_IMPORTED_MODULE_0__["withScope"](callback);
};
const captureException = error => {
  return _lib_constants__WEBPACK_IMPORTED_MODULE_1__[/* USE_SENTRY */ "f"] ? _sentry_browser__WEBPACK_IMPORTED_MODULE_0__["captureException"](error) : '';
};
const configureScope = callback => {
  if (_lib_constants__WEBPACK_IMPORTED_MODULE_1__[/* USE_SENTRY */ "f"]) _sentry_browser__WEBPACK_IMPORTED_MODULE_0__["configureScope"](callback);
};
