...
/* harmony import */ var react_app_polyfill_ie11__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("jdA4");
...
/* harmony import */ var react_app_polyfill_stable__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__("xoQe");
...
/* harmony import */ var _plugins_sentry__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__("wBnB");
...
_plugins_sentry__WEBPACK_IMPORTED_MODULE_4__[/* init */ "b"]();
...
class MyApp extends next_app__WEBPACK_IMPORTED_MODULE_1___default.a {
  ...
  componentDidCatch(error, errorInfo) {
    _plugins_sentry__WEBPACK_IMPORTED_MODULE_4__[/* withScope */ "c"](scope => {
      Object.keys(errorInfo).forEach(key => {
        scope.setExtra(key, errorInfo[key]);
      });
      _plugins_sentry__WEBPACK_IMPORTED_MODULE_4__[/* captureException */ "a"](error);
    });
...
var _process$env$NODE_ENV, _process$env$LADDER_P;


const NODE_ENV = (_process$env$NODE_ENV = "production") !== null && _process$env$NODE_ENV !== void 0 ? _process$env$NODE_ENV : 'development';
const LADDER_VERSION = package_0["a" /* version */] !== null && package_0["a" /* version */] !== void 0 ? package_0["a" /* version */] : '0.1.0';
...
const withScope = callback => {
  if (hasSentryDSN) Object(browser_["withScope"])(callback);
};
const captureException = error => {
  return hasSentryDSN ? Object(browser_["captureException"])(error) : '';
};
